...
public class CNContentIntegrityV1V2IT extends ContextAwareTestCaseDataone
implements  ContentIntegrityTestDefinitions {
    ...
    {
        contentTestImpl.testResourceMap_Parsing(getCoordinatingNodeIterator(), "v1");
    }
    ...
    {
        contentTestImpl.testResourceMap_Checksum_Size_Consistency(getCoordinatingNodeIterator(), "v1");
    }
    ...
    {
        contentTestImpl.testMetadata_Checksum_Size_Consistency(getCoordinatingNodeIterator(), "v1");
    }
    ...
    {
        contentTestImpl.testResourceMapParsing(getCoordinatingNodeIterator(), "v1");
    }
    ...
    {
        contentTestImpl.testResourceMap_ResolveURL(getCoordinatingNodeIterator(), "v1");
    }
