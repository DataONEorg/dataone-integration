...
<html>
	...
	%>
		...
		<form action="./mntester_" method="get">
			<div class="padded" style="font-weight: bold;">URL of DataONE Member Node Web Service*: <input
					title="URL of Web Service" size="100" name="mNodeUrl" type="text" /><input type="submit" alt="Submit"
					value="Submit"/>
			</div>
