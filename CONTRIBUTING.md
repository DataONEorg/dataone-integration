...
- Report a bug or request a new feature in our [issue
  tracker](https://github.com/DataONEorg/dataone-integration/issues)
...
- add an [issue](https://github.com/DataONEorg/dataone-integration/issues) describing your planned changes, or add a comment to an existing issue;
- on GitHub, fork the [repository](https://github.com/DataONEorg/dataone-integration)
...
https://github.com/DataONEorg/dataone-integration.  The repository is organized into several
...
3. Releases can be downloaded from the [GitHub releases
   page](https://github.com/DataONEorg/dataone-integration/releases).
